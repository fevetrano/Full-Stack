...
bola.init(); // Carrega a imagem uma vez fora do loop
...
function animacao(){
    ...
    bola.desenha();
    if(retangulo1.x >= 330) {
        retangulo1.direcao = -1
    };
     if(retangulo1.x <= 0) {
         retangulo1.direcao = 1
     };

    retangulo1.x = retangulo1.x + retangulo1.direcao
    
    // Correção da lógica do retangulo2 usando suas próprias propriedades
    if(retangulo2.largura >= 150) {
        retangulo2.direcao = -1
    }
    if(retangulo2.largura <= 10) {
        retangulo2.direcao = 1
    }

    retangulo2.altura = retangulo2.altura + retangulo2.direcao
    retangulo2.largura = retangulo2.largura + retangulo2.direcao
...
animacao(); // Chamada única para iniciar o loop